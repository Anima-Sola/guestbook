...
<?php
    if($isLoginExists && !$isEmailExists) echo "<script> modalWindow.showModalWindow('500', '200', 'px', '<div style=\'text-align: center; line-height: 200px;\'>Пользователь с таким Логином уже существует!</div>'); </script>";
    if($isEmailExists && !$isLoginExists) echo "<script> modalWindow.showModalWindow('500', '200', 'px', '<div style=\'text-align: center; line-height: 200px;\'>Пользователь с таким Email уже существует!</div>'); </script>";
    if($isEmailExists && $isLoginExists) echo "<script> modalWindow.showModalWindow('500', '200', 'px', '<div style=\'text-align: center; line-height: 200px;\'>Пользователь с таким Логином и Email уже существует!</div>'); </script>";
